...
export function StatCard({
    ...
    return (
        ...
        >
            ...
            {/* Label */}
            <p className="text-[10px] font-extrabold text-neutral-ink/90 tracking-wide mb-1 font-display">
                {label}
            </p>

            {/* Value */}
            <div className="flex items-baseline gap-1">
                <span className={cn('font-extrabold text-neutral-ink font-display', valueSizes[size])}>
                    {value}
                </span>
                {unit && (
