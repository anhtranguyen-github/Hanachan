            ...
            {loading ? (
                <div className="flex flex-col gap-4">
                    {Array.from({ length: 4 }).map((_, i) => (
                        <div key={i} className="h-32 clay-card animate-pulse bg-primary/5" />
                    ))}
                </div>
            ) : (
                <div className="flex flex-col gap-4">
                            ...
                            >
                                <div className="flex-1 flex flex-col gap-1">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="px-3 py-1 bg-primary/10 text-primary-dark text-xs font-black rounded-full border-2 border-primary-dark">{selectedJLPT}</div>
                                    </div>
