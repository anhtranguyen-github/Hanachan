...
export default function LearnOverviewPage() {
    ...
    return (
        <div className="flex-1 min-h-full flex flex-col justify-center py-8">
            <div data-testid="learning-overview-root" className="max-w-2xl mx-auto w-full space-y-4 font-sans text-foreground animate-page-entrance px-4">
                {/* Header */}
