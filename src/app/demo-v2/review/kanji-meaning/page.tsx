...
export default function ReviewKanjiMeaning() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (status !== 'idle') {
            router.push('/demo-v2/review/item');
            return;
        }
        ...
        <div className="fixed inset-0 bg-white flex flex-col font-sans text-[#3E4A61] overflow-hidden">
            ...
            <div className="px-12 py-4 space-y-2 shrink-0 max-w-5xl mx-auto w-full">
                <div className="flex justify-between items-end">
                    ...
                    <span className="text-[10px] font-black text-[#3E4A61]">16 / 42</span>
                </div>
                        ...
                        <div className="flex items-center gap-6">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className={`text-sm font-bold ${status === 'correct' ? 'text-[#48BB78]' : 'text-[#F56565]'
                                    ...
                                    {status === 'correct' ? 'Excellent! You got the meaning right.' : 'Take another look. You can do it next time.'}
                                </p>
                            </div>
                        </div>
                        <button
                            onClick={() => router.push('/demo-v2/review/item')}
