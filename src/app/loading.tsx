            ...
            <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-neutral-beige/10 backdrop-blur-sm pointer-events-auto">
                ...
                <div className="relative flex flex-col items-center gap-8">
                    ...
                    <div className="relative w-32 h-32 flex items-center justify-center">
                        ...
                        {/* Main Orb */}
                        <motion.div
                            className="w-16 h-16 bg-white border-2 border-primary/20 rounded-2xl  flex items-center justify-center z-10"
                            animate={{
                    ...
                    <div className="text-center space-y-2 z-10">
                        ...
                        <h2 className="text-xl font-black text-neutral-ink font-display  tracking-tight">
