...
async def test_create_session():
    ...
    with patch(
        "app.core.domain_client.DomainClient.upsert_chat_session", return_value=mock_response
    ) as mock_upsert:
...
async def test_get_session_success():
    ...
    with patch(
        "app.core.domain_client.DomainClient.get_chat_session", return_value=mock_response
    ) as mock_get:
