...
export const IS_DEV_AUTH = process.env.NEXT_PUBLIC_ENV === 'dev';

// Base URLs
export const APP_URL = process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:7100';
...
// Supabase
export const SUPABASE_URL = (typeof window === 'undefined' ? (process.env.SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL) : process.env.NEXT_PUBLIC_SUPABASE_URL) || '';
